...
when "centos"
  ...
  set[:db_postgres][:basedir] = "/var/lib/pgsql/#{node[:db_postgres][:version]}"
  set[:db_postgres][:confdir] = "/var/lib/pgsql/#{node[:db_postgres][:version]}/data"
  set[:db_postgres][:datadir] = "/var/lib/pgsql/#{node[:db_postgres][:version]}/data"
  set[:db_postgres][:bindir] = "/usr/pgsql-#{node[:db_postgres][:version]}/bin"
